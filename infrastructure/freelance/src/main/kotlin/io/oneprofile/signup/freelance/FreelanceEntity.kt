...
import io.oneprofile.signup.company.CompanyEntity
import io.oneprofile.signup.company.ContactEntity
import io.oneprofile.signup.company.PrivacyDetailEntity
...
fun toEntity(domain: FreelanceDomain): FreelanceEntity {
        return FreelanceEntity(
                ...
                company = domain.company?.let { io.oneprofile.signup.company.toEntity(it) },
                privacyDetail = domain.privacyDetail?.let { io.oneprofile.signup.company.toEntity(it) },
...
fun fromEntity(entity: FreelanceEntity): FreelanceDomain {
        return FreelanceDomain.Builder(entity.username)
                ...
                .company(entity.company?.let { io.oneprofile.signup.company.fromEntity(it) })
                .privacyDetail(entity.privacyDetail?.let { io.oneprofile.signup.company.fromEntity(it) })
